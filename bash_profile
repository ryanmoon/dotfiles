export PS1="\[$(tput bold)\]\[$(tput setaf 7)\]🍕  \T \[$(tput setaf 9)\]\! $(tput setaf 3)\]\$(batterycharge) \[$(tput setaf 5)\] PWD:\w \[$(tput sgr0)\] \n👾   "
...
# source ~/bin/git_prompt.sh - worked once, then poof
